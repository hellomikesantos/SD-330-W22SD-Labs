...
namespace SD_330_W22SD_Lab_4.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public AddressesController(SD_330_W22SD_Lab_4Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Address != null ? 
                          ...
                          Problem("Entity set 'SD_330_W22SD_Lab_4Context.Address'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SD_330_W22SD_Lab_4Context.Address'  is null.");
            }
            var address = await _context.Address.FindAsync(id);
            if (address != null)
            {
